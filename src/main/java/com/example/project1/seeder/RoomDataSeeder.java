...
public class RoomDataSeeder implements CommandLineRunner {
    ...
    private void loadUserData() {
        ...
        Resident b = new Resident("001203000768", "Ngô Đình Luyện", "Male", "28/04/2003", "Hà Nội", "Student", "0911052885", a.getNoRoom(), "Chủ");
        a.addResident(b);
        b.setRoom(a);
        ResidentRepo.save(b);
        ...
        Resident d = new Resident("004206000238", "Người Thương Của Huy", "Male", "12/04/2003", "Hà Nội", "Student", "0344859662", c.getNoRoom(), "Chủ");
        c.addResident(d);
        d.setRoom(c);
        ResidentRepo.save(d);
        ...
        Resident f = new Resident("002304000568", "Lê Đình Trí Tuệ", "Male", "20/09/2003", "Hà Nội", "Student", "0233846110", e.getNoRoom(), "Chủ");
        e.addResident(f);
        f.setRoom(e);
        ResidentRepo.save(f);
        ...
        Resident h = new Resident("005602000683", "Phan Trọng Cường", "Male", "31/01/2003", "Hà Nội", "Student", "0344712997", g.getNoRoom(), "Chủ");
        g.addResident(h);
        h.setRoom(g);
        ResidentRepo.save(h);
        ...
        Resident j = new Resident("002305000329", "Nguyễn Xuân Phúc", "Male", "25/11/2003", "Hà Nội", "Student", "03467597002", i.getNoRoom(), "Chủ");
        i.addResident(j);
        j.setRoom(i);
        ResidentRepo.save(j);

        // Các cư dân khác trong Room 5
        Resident k = new Resident("002305000321", "Hồng Nhật", "Female", "11/25/2003", "Hà Nội", "Student", "03467597003", i.getNoRoom(), "Vợ cả");
        i.addResident(k);
        k.setRoom(i);
        ResidentRepo.save(k);

        Resident l = new Resident("002305000322", "Minh Quang", "Female", "12/11/2003", "Hà Nội", "Student", "03467597004", i.getNoRoom(), "Vợ đáy xã hội");
        i.addResident(l);
        l.setRoom(i);
        ResidentRepo.save(l);

        Resident m = new Resident("002305000323", "Việt Anh", "Female", "14/11/2003", "Hà Nội", "Student", "03467597005", i.getNoRoom(), "Vợ hai");
        i.addResident(m);
        m.setRoom(i);
        ResidentRepo.save(m);
    }
