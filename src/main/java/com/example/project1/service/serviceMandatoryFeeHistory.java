...
@Service
public class serviceMandatoryFeeHistory {
	@Autowired
	private MandatoryFeeHistoryRepository repo;
	
	//Tìm kiếm theo String keyword
	 public Page<MandatoryFeeHistory> listAll(String keyword,Integer pageNo){
