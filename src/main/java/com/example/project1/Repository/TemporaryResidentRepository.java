...
public interface TemporaryResidentRepository extends JpaRepository<TemporaryResident, Integer> {
    ...
    public Page<TemporaryResident> findByDateRange(@Param("startDate") String startDate,
    ...
    public Page<TemporaryResident> findByKeywordAndDateRange(@Param("keyword") String keyword,
    ...
    public Page<TemporaryResident> findByKeywordAndstartDate(@Param("keyword") String keyword,
    ...
    public Page<TemporaryResident> findByKeywordAndendDate(@Param("keyword") String keyword,
            @Param("endDate") String endDate, Pageable pageable);
