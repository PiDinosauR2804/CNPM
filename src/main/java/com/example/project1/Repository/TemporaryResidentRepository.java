...
public interface TemporaryResidentRepository extends JpaRepository<TemporaryResident, Integer> {
    ...
    @Query(value = "SELECT * FROM temporary_resident WHERE STR_TO_DATE(day_in, '%d/%m/%Y') BETWEEN STR_TO_DATE(:startDate, '%Y-%m-%d') AND STR_TO_DATE(:endDate, '%Y-%m-%d')", nativeQuery = true)
    ...
    @Query(value = "SELECT * FROM temporary_resident WHERE concat(id, name) LIKE %:keyword% AND STR_TO_DATE(day_in, '%d/%m/%Y') BETWEEN STR_TO_DATE(:startDate, '%Y-%m-%d') AND STR_TO_DATE(:endDate, '%Y-%m-%d')", nativeQuery = true)
    ...
    @Query(value = "SELECT * FROM temporary_resident WHERE concat(id, name) LIKE %:keyword% AND STR_TO_DATE(day_in, '%d/%m/%Y') >= STR_TO_DATE(:startDate, '%Y-%m-%d')", nativeQuery = true)
    ...
    @Query(value = "SELECT * FROM temporary_resident WHERE concat(id, name) LIKE %:keyword% AND STR_TO_DATE(day_out, '%d/%m/%Y') <= STR_TO_DATE(:endDate, '%Y-%m-%d')", nativeQuery = true)
 ...
 // Tìm kiếm theo ngày bắt đầu
    @Query(value = "SELECT * FROM temporary_resident WHERE STR_TO_DATE(day_in, '%d/%m/%Y') >= STR_TO_DATE(:startDate, '%Y-%m-%d')", nativeQuery = true)
    ...
    @Query(value = "SELECT * FROM temporary_resident WHERE STR_TO_DATE(day_out, '%d/%m/%Y') <= STR_TO_DATE(:endDate, '%Y-%m-%d')", nativeQuery = true)
