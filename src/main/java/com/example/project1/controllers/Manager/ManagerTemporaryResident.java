...
public class ManagerTemporaryResident {
	...
	@GetMapping ("/manager/temporary_resident/indexTemp")
	public String index(Model model,
	    ...
	    return "manager/temporary_resident/indexTemp";
	}
    ...
    @PostMapping("/manager/temporary_resident/create")
    public String save(TemporaryResident temp) {
    	TemporaryResident save = repo.save(temp);
        repo.save(save);
        return "redirect:/manager/temporary_resident/indexTemp";
    }
